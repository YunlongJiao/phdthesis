...
\title{Survival Prediction and Molecular Feature Selection for Breast Cancer Prognosis}
...
\enkeyword{Breast Cancer, Prognosis, Survival Prediction, Molecular Feature Selection, Genomic Data Analysis}
}
...
\newpage\vspace*{\fill}
\begin{prechap}{Abstract}%
\input{abstract-en}%
\end{prechap}
\vskip 0.5in
\begin{prechap}{Résumé}%
\input{abstract-fr}%
\end{prechap}
\vspace*{\fill}
\cleardoublepage

...
{
bookmarksopen=true,
pdftitle="Rank-based Molecular Prognosis and Network-guided Biomarker Discovery for Breast Cancer",
pdfauthor="Yunlong JIAO", 
pdfsubject="Bioinformatics", %subject of the document
...
% list of publication
\newenvironment{publication}[1][List of Thesis Deliverables]%
{\chapter*{#1}%
\addcontentsline{toc}{chapter}{#1}%
\markboth{#1}{#1}}%
{}

...
The work in this chapter has been submitted as joint work with Marta R. Hidalgo, Cankut \c{C}ubuk, Alicia Amadoz, Jos\'{e} Carbonell-Caballero, Jean-Philippe Vert and Joaqu\'{i}n Dopazo in \cite{Jiao2017Signaling}.
\end{chapabstract}
\vskip 0.2in
...
\subsection{Signaling Pathway Activities Lead to Improved Prognosis for Breast Tumor Samples}
...
\subsection{Signaling Circuits Selected as Features Relevant for Cancer Prognosis Account for Cancer Hallmarks}
